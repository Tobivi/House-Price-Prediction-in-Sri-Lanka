...
st.title("House Prices Prediction in sri-lanka")

image = Image.open("Sri lanka.jfif")
st.image(image,caption = 'House Prices prediction in sri-lanka')
    
# st.markdown(style,image,unsafe_allow_html=True)
...
with open('rf_model.joblib', 'rb') as rf_model:
